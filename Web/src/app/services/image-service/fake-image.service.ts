...
const categories = [
    ...
    },
    {
        ...
        name: "Animals",
        link:
            "https://assets.change.org/photos/0/ys/te/RbystepLvbGJuix-800x450-noPad.jpg?1509858550",
    },
    {
        id: 3,
        name: "Art",
...
export class FakeImageService implements ImageService {
    ...
    getComments(criteria: CommentSearchCriteria): Observable<ImageComment[]> {
        ...
        const slicedComments = this.comments.slice(currentIndex, nextIndex);

        return of(slicedComments);
    }
