...
export class SettingsComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild("fileContainerRef") fileContainerRef: ElementRef<
        HTMLInputElement
    >;
    ...
    constructor(
        ...
        this.aboutMe = new FormControl({ value: "", disabled: true }, [
    ...
    ngAfterViewInit(): void {
        const {
            width,
            height,
        } = this.fileContainerRef.nativeElement.getBoundingClientRect();
        this.previewStyle = {
            ...this.previewStyle,
            width: `${width}px`,
            height: `${height}px`,
    ...
    saveImage() {
        this._userService.updateProfile({}).subscribe((_) => {});
    }
    ...
    set(property: keyof SettingsComponent, value: boolean) {
        ...
        if (value) {
            ...
            this._userService.updateProfile(data).subscribe((pr) => {});
